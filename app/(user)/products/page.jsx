...
export const metadata = {
  ...
  description:
    "Preorder Blue Sands immersive EdTech devices for K–12: the AR Vision Headset, Smart Interactive Board, STEM Lab Kit, and Immersive Learning Tablet. Pay securely in full at checkout.",
