...
export const SITE_TAGLINE = "Immersive AR-powered STEM learning for K–12";
export const SITE_DESCRIPTION =
  "Immersive AR-powered STEM learning devices for K–12 schools and families across Nigeria — AR headsets, smart boards, lab kits and learning tablets. Preorder with secure full payment.";
...
// Convenience for titles, e.g. "AR Vision Headset — $1,500".
export const productMetaTitle = (p) =>
  `${p.name.replace("Blue Sands ", "")} — ${fmtUSD(p.priceUSD)}`;
