...
// a one-off NGN price and a per-kit Paystack line item. A blackboard and a
// per-student annual subscription fit none of that, so they are kept apart and
// only the /products/[slug] route, the sitemap and the SEO builders read both.
//
...
// instead of a number. The tablet is an annual per-student subscription priced
// in USD by the vendor, so it is NOT run through <Price>: that component pairs
// an authored USD figure with the NGN amount Paystack actually charges, and
// there is no authored NGN here. Showing "$150" plainly is the honest render.
// When a naira price is agreed, add `priceNGN` and switch to <Price>.
// ─────────────────────────────────────────────────────────────────────────────
export const TABLET_SUBSCRIPTION_USD = 150;
...
export const solutions = [
  {
    ...
    hero: {
      src: "/real-products/smart-blackboard-1.jpeg",
      w: 1456,
      h: 672,
    ...
    price: { mode: "coming-soon", note: "Quoted per classroom, including mounting and teacher training." },
    ...
    // smart-blackboard-1.jpeg (1456x672). Each one points at something actually
...

  {
    ...
    blurb: "A learning tablet with a full virtual science lab, $150 per student a year.",
    description:
    ...
    hero: {
      src: "/real-products/smart-tablet-2.png",
      w: 1024,
      h: 1024,
    ...
    price: {
      mode: "subscription",
      usd: TABLET_SUBSCRIPTION_USD,
      unit: "Per student · per school · per year",
      note: "Priced in USD. Contact us for the naira equivalent and school-wide quantities.",
      includes: [
    ...
    heroHighlights: [
      ...
      { value: "$150", label: "Per student, per year" },
    ],

    // The arithmetic a head teacher does on paper before deciding. Every figure
    // the calculator shows is $150 x students, so nothing is estimated or
    // claimed: it is the school's own number, worked out on the page.
    calculator: {
      kicker: "What it costs your school",
      title: "Work out your school's number",
      body: "The subscription is charged per student, per year. Put your enrolment in and the page does the multiplication you were about to do yourself.",
      presets: [120, 350, 800, 1500],
      defaultStudents: 350,
      classSize: 35,
    },
    ...
    featureGroups: [
      ...
      },
      {
        ...
        body: "A library that keeps growing through the subscription period.",
        items: [
          "Science",
          "Mathematics",
          "English Language",
    ...
    checklist: {
      ...
      title: "Every annual subscription covers",
      items: [
        "Smart Tablet learning platform",
    ...
    ecosystem: {
      ...
      items: [
        { Icon: Monitor, label: "Smart Blackboard", href: "/products/smart-blackboard" },
        { Icon: FlaskConical, label: "STEM Laboratory Solutions" },
