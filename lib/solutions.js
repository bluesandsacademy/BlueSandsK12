...
// instead of a number. The Virtual Science Lab Tablet is a per-student annual
// subscription with two tiers, depending on whether Blue Sands supplies the
// tablet hardware or the school brings its own device, plus a lower renewal
// rate from the second year. All three figures are authored in USD only (see
// TABLET_TIER_WITH_USD / TABLET_TIER_WITHOUT_USD / TABLET_RENEWAL_USD below);
...
export const solutions = [
...

  {
    ...
    price: {
      ...
      unit: "Per student · per school · per year",
      note: `Priced in USD. $${TABLET_TIER_WITHOUT_USD} per student, per year if your school brings its own device instead. Renews at $${TABLET_RENEWAL_USD} per student, per year from year two. Contact us for the naira equivalent and school-wide quantities.`,
    },

    heroHighlights: [
      { value: "27", label: "Topic areas across 4 sciences" },
      { value: "9", label: "Subjects in the textbook library" },
      { value: "$100–$150", label: "Per student, per year" },
    ],

    faqs: [
      {
        q: "What's the difference between the two prices?",
        a: "$150 per student, per year includes a Smart Tablet supplied by Blue Sands. $100 per student, per year is the same learning platform, Virtual Science Labs, STEM simulations, digital textbooks, Learning Management System, teacher dashboard, assessments and support, running on a compatible device your school already owns. Both renew at $75 per student, per year from the second year.",
      },
      {
