...
export const preorderSteps = [
  ...
  { Icon: CreditCard, title: "Pay in Full", sub: "Secure checkout via Paystack — your slot is reserved instantly." },
  { Icon: Truck, title: "Delivery & Setup", sub: "We deliver and set everything up for you — and keep you posted on your delivery date." },
  { Icon: Rocket, title: "Transform Learning", sub: "Watch curiosity and STEM scores take off." },
];
